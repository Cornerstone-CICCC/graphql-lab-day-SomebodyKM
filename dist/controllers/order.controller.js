...
const getOrderByProductId = (productId) => __awaiter(void 0, void 0, void 0, function* () {
    const order = yield order_model_1.Order.find({ productId });
    return order;
});
// Get order by customerId
const getOrderByCustomerId = (customerId) => __awaiter(void 0, void 0, void 0, function* () {
    const order = yield order_model_1.Order.find({ customerId });
    return order;
});
// Update order
