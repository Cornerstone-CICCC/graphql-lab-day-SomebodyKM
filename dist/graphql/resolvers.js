...
exports.resolvers = {
    ...
    Product: {
        customers: (parent) => __awaiter(void 0, void 0, void 0, function* () {
            const orders = yield order_controller_1.default.getOrderByProductId(parent._id);
            const customerIds = orders.map(o => o.customerId);
            const customers = yield customer_controller_1.default.getCustomerByIds(customerIds);
            return customers;
        })
    },
    Customer: {
        products: (parent) => __awaiter(void 0, void 0, void 0, function* () {
            const orders = yield order_controller_1.default.getOrderByCustomerId(parent._id);
            const productIds = orders.map(o => o.productId);
            const products = yield product_controller_1.default.getProductByIds(productIds);
            return products;
        })
    },
    Order: {
